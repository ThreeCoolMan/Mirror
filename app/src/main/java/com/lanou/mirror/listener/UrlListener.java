...
public interface UrlListener {
    ...
    //加入购物车 编码 m008
    String JOIN_SHOPING_CART_URL = SERVER_SIDE_URL + "index.php/order/join_shopping_cart";
    //订单列表 编码 m009
    String ORDER_LIST_URL = SERVER_SIDE_URL + "index.php/order/order_list";
    //购物车列表 编码 m010
    String ORDER_SHOPING_CART_LIST_URL = SERVER_SIDE_URL + "index.php/order/shopping_cart_list";
    //我的收获地址 编码 m011
    ...
    //我的优惠券 编码 m024
    String UESR_DISCOUNT_LIST_URL = SERVER_SIDE_URL + "index.php/user/discount_list";
    //启动图
